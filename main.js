...
const { runStatusCheck } = require("./src/status"); // Added Status import
const { performCFDTask } = require("./src/cfd"); // Added CFD Trading import

// ---- CONSTANTS ----
const nfts = [{'address': '0x1da9f40036bee3fda37ddd9bff624e1125d8991d', 'name': 'Pharos Octopus Badge'}, {'address': '0x7fB63bFD3Ef701544BF805e88CB9D2Efaa3C01A9', 'name': 'FaroSwap Captain Dolphin'}, {'address': '0x2a469A4073480596b9deB19f52aA89891CcFF5ce', 'name': 'FaroSwap Baby Dolphin'}, {'address': '0xe71188DF7be6321ffd5aaA6e52e6c96375E62793', 'name': 'Zentra Octopus Badge'}, {'address': '0xb2ac4f09735007562c513ebbe152a8d7fa682bef', 'name': 'Gotchipus Testnet Badge'}, {'address': '0x0D00314d006e70cA08ac37C3469b4bF958A7580B', 'name': 'AutoStaking Testnet Badge'}, {'address': '0x96381ed3fcfb385cbacfe6908159f0905b19767a', 'name': 'Spout Badge'}, {'address': '0x4af366c7269DC9a0335Bd055Af979729c20e0F5F', 'name': 'PNS Badge'}];
...
let global = {
  ...
  cfdTxCount: 1, // Added CFD transaction count
};
...
const menuOptions = [
  ...
  { label: "CFD Trading Task", value: "performCFDTask" }, // Added CFD Trading option
  { label: "Check Status", value: "checkStatus" }, // Added Check Status option
